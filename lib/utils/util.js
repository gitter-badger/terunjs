...
exports.validObjectThrow = validObjectThrow;
exports.log = log;
exports.fn = void 0;
...
function underscore(value) {
  var _ref, _value, _ref2, _ref3, _value2;
  ...
  return _ref2 = (_ref3 = (_value2 = value, split(_value2)), ((_arg2) => {
...
function validObjectThrow(config, args) {
  let errorsBaseConfig = getMissingProperties(config, args);
  let hasError = errorsBaseConfig && errorsBaseConfig.length > 0;
  if (hasError) errorsBaseConfig.forEach(error => {
    throw new Error(`Not found parameter ${error}`);
  });
  return !hasError;
}
