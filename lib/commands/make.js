...
class Make {
  ...
  renderFile(args_to_render, from_file) {
    ...
    console.log(args_to_render); // RENDER final file

    return _mustache.default.render(content, args_to_render || {});
  }
  ...
  getTransport(transport) {
    return new Promise((resolve, reject) => {
      ...
      _prompt.default.get(transport.args, async (err, result) => {
        ...
        let to_file_rendered = _mustache.default.render(to_file, argsToFileNameRender || {}); // render final file
        ...
        if (plugins) {
          ...
          if (symfonyEntityReaderConfig) {
            symfonyEntityReaderConfig.from = _mustache.default.render(symfonyEntityReaderConfig.from, argsToFileNameRender || {});
