...
class SymfonyEntity {
  ...
  async beforeRender(objectToSetArgs = {}) {
    ...
    objectToSetArgs['s:class_cap'] = (0, _util.camelize)((await this.getClassName()));
    objectToSetArgs['s:class_plural_lower'] = (0, _util.pluralName)((await this.getClassName())).toLowerCase();
    objectToSetArgs['s:class_plural_cap'] = (0, _util.camelize)((0, _util.pluralName)((await this.getClassName()))); // set parameters
  ...
  async getEntityPropertiesToView() {
    ...
    properties = properties.map(propertie => `${(0, _util.camelize)(propertie)}`);
    return properties;
  }
