...
class SymfonyEntityForm {
  ...
  async inRender(objectToSetArgs = {}) {
    ...
    objectToSetArgs['s:class_upper'] = (0, _util.capitalize)((await this.getClassName()));
    objectToSetArgs['s:class_plural_lower'] = (0, _util.pluralName)((await this.getClassName())).toLowerCase();
    objectToSetArgs['s:class_plural_upper'] = (0, _util.capitalize)((0, _util.pluralName)((await this.getClassName()))); // set parameters
