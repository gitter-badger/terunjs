...
class Android {
  ...
  async beforeRender(objectToSetArgs = {}) {
    ...
    objectToSetArgs['android:tableName_camel'] = (0, _util.camelize)(this.tableName);
    objectToSetArgs['android:tableName_lower'] = (0, _util.camelize)(this.tableName).toLowerCase();
  ...
  async getAttributes(columns) {
    ...
    for (let column of columns) {
      ...
      column.attr = (0, _util.camelizeLessFirst)(column.name);
